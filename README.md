...
3. Set default ebook mode to `Request Release`.
   - Habitat Calibre now uses release-first requests (search release -> select
     release -> submit request).
   - `Request Book` policy will reject selected-release submissions.
